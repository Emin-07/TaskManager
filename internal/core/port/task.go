...
type TaskService interface {
	...
	Post(ctx context.Context, task *domain.CreateTask, userId int) (int64, error)
...
type TaskRepo interface {
	...
	Insert(ctx context.Context, title, text string, priority, expireDays, userId int) (int64, error)
